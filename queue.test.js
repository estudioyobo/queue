...
describe("Publish range 09:00 - 21:00", () => {
  ...
  it("should publish on 10:21", () => {
    ...
    now.setMinutes(21);
    // MockDate.set(now);
    const inRange = isInPublishingRange(now, {
      startTime: "09:00",
      endTime: "21:00"
    });
...
//     const inRange = isInPublishingRange(now, end);
//     expect(inRange).toBeTruthy();
//   });
//   test("should NOT publish on 22:55 if ends in 22:30", () => {
//     const end = "22:30";
//     const date = "22:55";
//     const now = new Date();
//     const [hour, minutes] = date.split(":");
...
//     expect(inRange).toBeFalsy();
//   });
//   test("should NOT publish on 00:00 if ends in 23:59", () => {
//     const end = "23:59";
//     const date = "00:00";
//     const now = new Date();
//     const [hour, minutes] = date.split(":");
...
//     expect(inRange).toBeFalsy();
//   });
//   test("should publish on 23:55 if ends in 23:59", () => {
//     const end = "23:59";
//     const date = "23:55";
//     const now = new Date();
//     const [hour, minutes] = date.split(":");
...
//     expect(inRange).toBeTruthy();
//   });
//   test("should NOT publish on 1:12 if ends in 23:59", () => {
//     const end = "23:59";
//     const date = "1:12";
//     const now = new Date();
//     const [hour, minutes] = date.split(":");
...
//     expect(inRange).toBeFalsy();
//   });
//   test("should publish on 1:00 if ends in 2:10", () => {
//     const end = "2:10";
//     const date = "1:00";
//     const now = new Date();
//     const [hour, minutes] = date.split(":");
...
//     expect(inRange).toBeTruthy();
//   });
//   test("should NOT publish on 2:35 if ends in 2:10", () => {
//     const end = "2:10";
//     const date = "2:35";
//     const now = new Date();
//     const [hour, minutes] = date.split(":");
...
//     expect(inRange).toBeFalsy();
//   });
//   test("should publish on 22:15 if ends in 2:10", () => {
//     const end = "2:10";
//     const date = "22:15";
//     const now = new Date();
//     const [hour, minutes] = date.split(":");
...
//     expect(inRange).toBeTruthy();
//   });
//   test("should publish on 22:00 if ends in 2:10", () => {
//     const end = "2:10";
//     const date = "22:00";
//     const now = new Date();
//     const [hour, minutes] = date.split(":");
